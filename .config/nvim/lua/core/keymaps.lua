...
bind('n', '<leader>wc', ':close<CR>', { desc = 'close current window' })
bind('n', '<leader>ws', '<C-w>j', { desc = 'move to down window' })
bind('n', '<leader>ww', '<C-w>k', { desc = 'move to up window' })
bind('n', '<leader>wa', '<C-w>h', { desc = 'move to left window' })
bind('n', '<leader>wd', '<C-w>l', { desc = 'move to right window' })
